...
# API Commands
api_methods = {
    "erpnext_shipping.erpnext_shipping.doctype.one_world_express.one_world_express.test_connection": ["POST"],
    "erpnext_shipping.erpnext_shipping.api.test_one_world_connection": ["POST"],
} 